...
class NestedLoopJoinExecutor : public AbstractExecutor {
   ...
   public:
    ...
    std::unique_ptr<RmRecord> Next() override {
        ...
        // memecpy()可能对你有所帮助
        // lab3 task2 Todo End
        auto l_record = left_->Next(), r_record = right_-> Next();
        memcpy(record->data, l_record->data, l_record->size);
        memcpy(record->data + l_record->size, r_record->data, r_record->size);
        return record;
    }
